...
public class CubeJSPerSchoolReader extends AbstractCubeJSReader {
    ...
    public static final String QUERY = "{\"limit\":50000,\"measures\":[\"Sessions.count\",\"Events.activeUsers\"],\"dimensions\":[\"Sessions.schoolId\"],\"timeDimensions\":[{\"dimension\":\"Events.timeStamp\",\"dateRange\":\"last 100 days\",\"granularity\":\"day\"}]}";
